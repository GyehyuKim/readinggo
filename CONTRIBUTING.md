...
- `owner` — 작업자의 고정 slug. 3명 외 금지.
  | 사람 | slug | 영역 |
  |---|---|---|
  | 김계휴 | `gyehyu` | 백엔드·소셜·내서재·로그인 |
  | 이승원 | `seungwon` | 둥지·XP·디자인 |
  | 정윤지 | `yunji` | 마을 |
...
- **GitHub Fork** — 팀원 4명 모두 `GyehyuKim/readinggo` 원본 repo에 직접 push 권한 보유. Fork 기반 워크플로우 사용 금지. 모든 브랜치는 원본 repo에 직접 생성한다.
