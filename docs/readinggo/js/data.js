  ...
  towns: [
    {
      ...
      capacity: 12,
      myRole: "admin",
      coAdmins: ["quiet_rabbit"],
      notificationPrefs: { poke: false, board: true, deadline: true, complete: true },
      memberCount: 7,
      currentPart: 2,
      totalParts: 5,
      dday: -4,
    ...
    },
    {
      ...
      isOpen: true,
      leader: "@curious_fox",
      currentRange: "4~6장: 천국과 지옥",
      status: "active",
      milestones: [
        { part: 1, dueDate: "5/20", completed: true },
        { part: 2, dueDate: "6/10", completed: false },
        { part: 3, dueDate: "6/25", completed: false },
        { part: 4, dueDate: "7/10", completed: false },
      ],
      members: [
        { name: "curious_fox",    nest: "🏠", avatar: "🦊", todayRecorded: true,  quote: "코스모스는 존재했고 지금도 존재하고 앞으로도 존재할 그 모든 것이다", cumulativePage: 316, streak: 9,  xp: 510 },
        { name: "owl_n",          nest: "🏰", avatar: "🦉", todayRecorded: true,  quote: "우리는 별의 먼지로 만들어져 있다. 우주가 자기 자신을 들여다보는 한 방식이다", cumulativePage: 540, streak: 88, xp: 620 },
        { name: "book_bear",      nest: "🏰", avatar: "🐻", todayRecorded: true,  quote: "우주의 광대함 앞에서 인간의 오만이 얼마나 작은지 새삼 느꼈다", cumulativePage: 428, streak: 64, xp: 920 },
        { name: "quiet_rabbit",   nest: "🏡", avatar: "🐰", todayRecorded: true,  quote: "우주 어딘가에 분명히 다른 생명이 있을 것이다. 그 상상만으로도 경이롭다", cumulativePage: 212, streak: 21, xp: 740 },
        { name: "kaist_spark",    nest: "🏡", avatar: "🔭", todayRecorded: true,  quote: "우리 은하에만도 4000억 개의 별이 있다는 사실에 압도됐다", cumulativePage: 368, streak: 33, xp: 680 },
        { name: "kaist_nova",     nest: "🪹", avatar: "🌟", todayRecorded: true,  quote: "빛의 속도로 달려도 가장 가까운 별까지 4년이 걸린다는 게 실감이 안 된다", cumulativePage: 316, streak: 7,  xp: 210 },
        { name: "deer_s",         nest: "🪵", avatar: "🦌", todayRecorded: true,  quote: "별들의 탄생과 죽음이 곧 우리의 존재를 만들었다는 것이 놀랍다", cumulativePage: 108, streak: 3,  xp: 140 },
        { name: "fox_c",          nest: "🏠", avatar: "🦊", todayRecorded: false, quote: "", cumulativePage: 263, streak: 9,  xp: 420 },
        { name: "activist_raccoon", nest: "🪹", avatar: "🦝", todayRecorded: false, quote: "", cumulativePage: 54,  streak: 5,  xp: 180 },
        { name: "kaist_wave",     nest: "🏠", avatar: "🌊", todayRecorded: false, quote: "", cumulativePage: 162, streak: 18, xp: 490 },
        { name: "jerome",         nest: "🏠", avatar: "🐦", todayRecorded: false, quote: "", cumulativePage: 108, streak: 12, xp: 340 },
      ],
    },
  ],
};
