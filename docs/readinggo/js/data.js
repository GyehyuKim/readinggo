...
const INITIAL_STATE = {
  ...
  towns: [
    ...
    },
    {
      ...
      isOpen: true,
      leader: "@curious_fox",
      currentRange: "프롤로그~1부",
      status: "active",
      milestones: [
        { part: 1, dueDate: "6/09", completed: false },
        { part: 2, dueDate: "6/19", completed: false },
        { part: 3, dueDate: "6/29", completed: false },
        { part: 4, dueDate: "7/09", completed: false },
      ],
      members: [
        { name: "curious_fox", nest: "🏠", avatar: "🦊", todayRecorded: true, quote: "같이 읽는 힘이 느껴진다", cumulativePage: 198, streak: 9, xp: 510 },
        { name: "book_bear", nest: "🏰", avatar: "🐻", todayRecorded: true, quote: "사피엔스를 다시 읽고 싶어졌다", cumulativePage: 412, streak: 64, xp: 920 },
        { name: "jerome", nest: "🏠", avatar: "🐦", todayRecorded: false, quote: "", cumulativePage: 87, streak: 12, xp: 340 },
      ],
    },
  ],
};
