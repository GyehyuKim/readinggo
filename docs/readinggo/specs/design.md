...
> **v17 목표 결정 (2026-08-19, #1453·#1455)**: 책나무는 수백 권·수백 문장을 나무 한 장에 모두 배치하지 않는다. 나무는 개요, 가지 목록과 문장 상세는 정확한 탐색을 담당한다. Lucide 공식 아이콘 3안은 팀 공유 후 최종 선택 보류이며, 캐릭터 이름도 팀 결정 보류로 `Jacky / 재키`를 유지한다.

## 10. 책나무 시각·상호작용 계약 (v17)
