...
| **둥지 탭** | [`nest.md`](./nest.md) | [§5.1](./nest.md)-5.4 The Path·진화·활성책·일일미션 |
| **독서모임 + 운영자 짹** | [`book-club.md`](./book-club.md) | [§5.5](./book-club.md)-5.6 (v6: 마을 → 독서모임) |
| **소셜 탭** | [`social.md`](./social.md) | [§5.7](./social.md) |
| **내서재(프로필)** | [`profile.md`](./profile.md) | [§5.8](./profile.md)-5.9 (v6: AI 도서 추천 포함) |
| **시스템 로직** | [`systems.md`](./systems.md) | [§6](./systems.md) 스트릭·방패·XP·NPC·리그 |
...
- **운영자 짹 대시보드** (`/operator`) [§5.6](./book-club.md)
...
- **OCR — `@capacitor-mlkit/text-recognition`** (v5 [§14](./meta/rejected.md) 기각 결정 부분 해제: 네이티브 환경 + 디바이스 내장 = 비용 0)
...
- T2 mini (같은 책 자동 패널) [§13.2](./meta/open-issues.md) 본 설계 진입
...
| 16 | 닉네임 RPC + 금칙어 사전 | 1 |
| 17 | 주간 리그 쿼리·캐시 | 1 |
| 18 | T2 mini (같은 책 자동 패널) 설계 확정 — [§13](./meta/open-issues.md) 안건 (학기 후) | 1+ |
| 19 | XP destination 설계 — [§13](./meta/open-issues.md) 안건 (학기 후) | 1+ |
