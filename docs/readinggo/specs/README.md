...
| **독서모임 + 운영자 짹** | [`book-club.md`](./book-club.md) | §5.5-5.6 (v6: 마을 → 독서모임) |
| **소셜 탭** | [`social.md`](./social.md) | §5.7 |
| **내서재(프로필)** | [`profile.md`](./profile.md) | §5.8-5.9 (v6: AI 도서 추천 포함) |
| **시스템 로직** | [`systems.md`](./systems.md) | §6 스트릭·방패·XP·NPC·리그 |
| **백엔드** | [`backend.md`](./backend.md) | §7 |
| **디자인** | [`design.md`](./design.md) | §11 + §12 |
| **메타: 여정** | [`meta/journey.md`](./meta/journey.md) | §0.5 |
| **메타: 결정 이력** | [`meta/decisions.md`](./meta/decisions.md) | §8 미결 → 확정 |
| **메타: 미해결** | [`meta/open-issues.md`](./meta/open-issues.md) | §13 |
| **메타: 기각** | [`meta/rejected.md`](./meta/rejected.md) | §14 |
