...
### v16 — 홈 상단 Lv를 완성 둥지 수로 대체 (#1415, 2026-08-16)

> Judy 제안과 Hyu 제품 결정을 반영해 v13의 사용자 노출 계약과 v15의 구 사용자 Lv 계산 비변경 범위를 대체한다. XP 적립과 1,600 XP 둥지 주기·내부 Lv1~5는 유지하고, 의미가 약한 사용자 레벨 숫자와 `calcLevel` 계산/API를 제거한다.
