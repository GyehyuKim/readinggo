...
| 카드 리뷰 (v7.2, #186) | 피드 상단 **'🃏 카드로 넘겨보기'** → 한 문장을 틴더식 스와이프 카드로. **우=좋아요**(짹+책갈피)·**좌=넘김**·**아래=유예**. **카드 중앙 상단에 책 표지·제목·저자**(카드 본문과 분리, QA3). 내 문장으로 책 리뷰 / 타인 문장으로 예습·복습. Pointer Events 직접 구현(Stack Lock, 라이브러리 없음) |
