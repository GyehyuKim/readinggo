...
- **인용 vs 감상 구분 (#359)**: LLM은 "한 문장"을 **작품 속 인용**으로, "메모"를 **사용자의 감상**으로 받는다(프롬프트에 역할 명시). 인용으로 보기 어렵거나(예: "즐거웠다") 작품 내 맥락을 모르면 **함부로 단정하지 않고 독자에게 맥락을 되묻는다**. 입력 단계 구분은 [#360 내 의견 남기기]와 연계.
