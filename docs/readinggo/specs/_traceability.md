...
| 질문 품질(반복방지·책맥락·난이도) · 평가👍👎 · 재생성🔄 · 방향성 프리셋 | 🔧 | 평가👍👎(#371)·재생성🔄(#372)·프리셋(#375, '작가의 시선' #936 추가) ✅ companion.js. **질문 품질필터(#373 반복·맥락·난이도)는 미구현 — #373 CLOSED지만 실구현 없음(#877 감사)** |
...
- **#877 감사 결과**: 둥지 1,600 XP(#520/#521) ✅ · 친구찾기 NPC_SEARCH(#250) ✅ · companion 평가👍👎/재생성🔄/프리셋 ✅, **질문 품질필터(#373) ⏳미구현(CLOSED 오닫힘 — reopen 검토)** · **AI 다음책 추천/추출 ⏳빈 stub** · parking-lot 3건(#126/#191/#208) 재개조건 미충족(정상 보류).
