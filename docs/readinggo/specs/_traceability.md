...
| `meta/decisions.md` | 현재 활성 결정 | 📝 | #1389 은퇴 tombstone과 v18 서재·개인 활동·안전·전달 경계를 반영 |
| `mascot.md` | `SparrowMark`, 로그인·헤더·동반자·공유·스토어 표면 | 📝 | #1389 비진화형 2D 참새 계약과 3종 모델 시트 검토 기준. 자산 교체·DEV 비교는 후속 |
