...
const ugcPreflight = home.indexOf('if (window.DataStore === window.SupabaseDataStore');
const ugcRequired = home.indexOf("window.dispatchEvent(new CustomEvent('rg:ugc-terms-required'))", ugcPreflight);
