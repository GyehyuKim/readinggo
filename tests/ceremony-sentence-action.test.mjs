...
assert.match(ceremony, /className="ceremony-action-primary" onClick=\{onContinue\}/,
  '기본 행동은 현재 책에서 계속 기록하기여야 한다');
...
assert.match(html, /\.ceremony-action-primary:focus-visible,[\s\S]*outline:/,
  '세 완료 행동의 키보드 포커스가 시각적으로 보여야 한다');
