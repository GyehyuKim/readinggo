...
do $$
declare
  v_owner uuid := '14540000-0000-4000-8000-000000000001';
  v_friend uuid := '14540000-0000-4000-8000-000000000002';
  v_stranger uuid := '14540000-0000-4000-8000-000000000003';
  v_book uuid;
  v_ub uuid;
  v_public uuid;
  v_followers uuid;
