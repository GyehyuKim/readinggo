...
> **v17 경계:** 현재 spec-align·Node green은 v7~v16 및 레거시 XP·둥지·스트릭 구현의 기준선이다. 레거시·최근 14일 리듬·누적 성장일·XP 쓰기 동결·친구/비친구/차단 RLS를 검증하는 v17 invariant와 Production E2E는 아직 없다.
...
| **Unit** | XP·둥지·스트릭 테스트는 레거시 as-built 기준선 | 레거시 파생·성장 리듬·공개범위 fail-closed 계약 |
