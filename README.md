...
- **책 단위 공개 안전** — 새 서재 책은 비공개. 공개를 선택한 책의 모든 현재·미래 문장·생각만 서버 권한에 따라 로그인 없이 읽는다. 비공개 책의 문장/책 공유는 전체 책 공개 확인·저장 성공 뒤 이어가며 언제든 책을 비공개로 되돌릴 수 있다. [활성 목표 #1619](docs/readinggo/specs/backend.md)는 후속 구현·검증 대상이다.
